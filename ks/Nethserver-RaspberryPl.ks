...
repo --name="instneth-base"    --baseurl=http://mirror.framassa.org/nethserver7-arm/7/base/armhfp/ --cost=100
repo --name="instneth-updates" --baseurl=http://mirror.framassa.org/nethserver7-arm/7/updates/armhfp/ --cost=100

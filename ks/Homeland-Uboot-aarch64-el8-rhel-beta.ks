...
# Repositories to use
repo --name="base"     --baseurl=http://downloads.redhat.com/redhat/rhel/rhel-8-beta/baseos/aarch64/ --cost=100
...
#
# Uboot images from copr epel-7_SBC-tools carry a CentOS specific patch
cp -r -p /boot/efi/EFI/redhat /boot/efi/EFI/centos
...
cat >/root/README << EOF
== Homeland el8 development AARCH64 image ==

Note: this is a community effort not supported by or associated with rhel by any means

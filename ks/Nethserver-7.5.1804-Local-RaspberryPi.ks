...
repo --name="nethserver-base"    --baseurl=http://nethdev.havak.lan/nethserver/7.5.1804/base/armhfp/    --cost=100
repo --name="nethserver-updates" --baseurl=http://nethdev.havak.lan/nethserver/7.5.1804/updates/armhfp/ --cost=100
repo --name="epel"               --baseurl=http://nethdev.havak.lan/nethserver/7.5.1804/ns-epel/armhfp/ --cost=100
